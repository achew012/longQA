...
def convert_char_indices(ans_char_start: int, ans_char_end: int, spans_list: List[List[Tuple[int, int]]], max_idx: int) -> List:
        ...
        for question_answer_pair in question_answer_pair_list:
            ...
            for ans_char_start, ans_char_end, mention in answers:
                token_span = convert_char_indices(
                    ans_char_start, ans_char_end, offsets_wo_pad, max_idx=offsets_wo_pad[-1][1])
